...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 29, 2021 at 06:10 AM
...
INSERT INTO `m_kabupaten` (`id`, `provinsi_id`, `name`) VALUES
...
(1302, 13, 'KAB. SOLOK'),
(1303, 13, 'KAB. SIJUNJUNG (SAWAH LUNTO SIJUNJUNG)'),
(1304, 13, 'KAB. TANAH DATAR'),
(1305, 13, 'KAB. PADANG PARIAMAN'),
(1306, 13, 'KAB. AGAM'),
(1307, 13, 'KAB. LIMA PULUH KOTO/KOTA'),
(1308, 13, 'KAB. PASAMAN'),
...
(6501, 65, 'KAB. BULUNGAN (Bulongan)'),
(6502, 65, 'KAB. MALINAU'),
(6503, 65, 'KAB. NUNUKAN'),
(6504, 65, 'KAB. TANA TIDUNG'),
(6571, 65, 'KOTA TARAKAN'),
(7101, 71, 'KAB. BOLAANG MONGONDOW (Bolmong)'),
...
(7109, 71, 'KAB. KEPULAUAN SIAU TAGULANDANG BIARO (SITARO)'),
...
(7271, 72, 'KOTA PALU'),
(7301, 73, 'KAB. SELAYAR (KEPULAUAN SELAYAR)'),
...
(7312, 73, 'KAB. SOPPENG'),
(7313, 73, 'KAB. WAJO'),
(7314, 73, 'KAB. SIDENRENG RAPPANG/RAPANG'),
(7315, 73, 'KAB. PINRANG'),
...
(9104, 91, 'KAB. NABIRE'),
(9105, 91, 'KAB. KEPULAUAN YAPEN (Yapen Waropen)'),
...
INSERT INTO `m_kecamatan` (`id`, `kabupaten_id`, `name`) VALUES
...
INSERT INTO `m_product` (`id`, `produk`, `harga`) VALUES
(1, 'VT330', '450000'),
(2, 'M20 Portable', '550000'),
(3, 'VT90Z', '100000'),
(4, 'C20', '150000'),
(5, 'S250', '560000'),
(6, 'S1 OBD', '780000');
...
INSERT INTO `m_provinsi` (`id`, `name`) VALUES
(11, 'Aceh'),
(12, 'Sumatera Utara'),
(13, 'Sumatera Barat'),
(14, 'Riau'),
...
INSERT INTO `tr_cart` (`id`, `produk_id`, `jumlah`, `status`) VALUES
(1, 1, 1, 1),
(2, 2, 2, 1),
(3, 3, 5, 1),
(4, 4, 10, 1),
...
--
-- Table structure for table `tr_cart_to_checkout`
--

CREATE TABLE `tr_cart_to_checkout` (
  `id` int(11) NOT NULL,
  `order_id` bigint(20) NOT NULL,
  `gross_amount` varchar(122) NOT NULL,
  `payment_type` varchar(122) NOT NULL,
  `bank` varchar(122) NOT NULL,
  `va_number` varchar(122) NOT NULL,
  `biller_code` varchar(122) NOT NULL,
  `transaction_status` varchar(122) NOT NULL,
  `transaction_time` varchar(122) NOT NULL,
  `pdf_url` varchar(122) NOT NULL,
  `date_created` int(11) NOT NULL,
  `date_modified` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tr_cart_to_checkout`
--

INSERT INTO `tr_cart_to_checkout` (`id`, `order_id`, `gross_amount`, `payment_type`, `bank`, `va_number`, `biller_code`, `transaction_status`, `transaction_time`, `pdf_url`, `date_created`, `date_modified`) VALUES
(1, 646111710, '450000', 'bank_transfer', 'bca', '20794345409', '', 'pending', '2021-06-23 10:26:18', 'https://app.sandbox.midtrans.com/snap/v1/transactions/5a5c3f94-05c0-4ad0-b6ca-0521983c707e/pdf', 1624418913, 1624418913),
(2, 928725062, '1120000', 'bank_transfer', 'bni', '9882079428067365', '', 'pending', '2021-06-23 10:30:15', 'https://app.sandbox.midtrans.com/snap/v1/transactions/24ff5264-a8c6-4498-8a7d-af3711e4189e/pdf', 1624419084, 1624419084),
(3, 1968023101, '1350000', 'bank_transfer', 'bca', '20794610259', '', 'pending', '2021-06-23 10:33:31', 'https://app.sandbox.midtrans.com/snap/v1/transactions/a152a7b6-b0d5-4fbc-b7a1-c2da815922a6/pdf', 1624419212, 1624419212),
(4, 687479604, '450000', 'bank_transfer', 'permata', '207000447111535', '', 'pending', '2021-06-23 10:37:30', 'https://app.sandbox.midtrans.com/snap/v1/transactions/72067a97-6d76-45fd-98a6-23153b7360eb/pdf', 1624419759, 1624419759),
(5, 1445978303, '450000', 'bank_transfer', 'bca', '20794870587', '', 'pending', '2021-06-29 11:07:30', 'https://app.sandbox.midtrans.com/snap/v1/transactions/0d6e9a66-c256-4510-8b72-9f1b5e3dce3d/pdf', 1624939655, 1624939655);
...
--
-- Indexes for table `tr_cart_to_checkout`
--
ALTER TABLE `tr_cart_to_checkout`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tr_cart_to_checkout`
--
ALTER TABLE `tr_cart_to_checkout`
